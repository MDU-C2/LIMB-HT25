...
esp_err_t servo_led_init(void) {
  ...
  // servo_write_deg_channel(0, 100); // thumb
  // servo_write_deg_channel(1, 100); // pinky
  // servo_write_deg_channel(2, 100); // ring
  // servo_write_deg_channel(3, 100); // mid
  // servo_write_deg_channel(4, 100); //index
