...
- `CAN_ID_ROBOT_ELBOW_IMU_GYRO_PITCH`
- `CAN_ID_ROBOT_ELBOW_IMU_GYRO_ROLL`
- `CAN_ID_ROBOT_ELBOW_IMU_GYRO_YAW`
- `CAN_ID_ROBOT_ELBOW_IMU_ACCEL_X`
- `CAN_ID_ROBOT_ELBOW_IMU_ACCEL_Y`
- `CAN_ID_ROBOT_ELBOW_IMU_ACCEL_Z`
