...
// Set to 1 to enable emergency fixed grip after calibration, 0 for normal PD control
#define SAFEWAY 1 
...
void loop_control(void) {
    ...
    switch (current_state) {
        ...
        case E2_STABLE:
            ...
            if (fabsf(stats.mean - setpoint_actual) > tolerance || stats.variance > 50.0f) {
        ...
        case E3_REACTION:
            ...
            if (fabsf(post_stats.mean - setpoint_actual) > tolerance || post_stats.variance > 50.0f) {
