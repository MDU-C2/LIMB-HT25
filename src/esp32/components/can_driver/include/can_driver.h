...
typedef enum {
  ...
  // IMU messages.
  CAN_ID_ROBOT_SHOULDER_IMU_GYRO = 0x5A0,
  CAN_ID_ROBOT_SHOULDER_IMU_ACCEL = 0x5A1,
  CAN_ID_ROBOT_ELBOW_IMU_GYRO = 0x5A2,
  CAN_ID_ROBOT_ELBOW_IMU_ACCEL = 0x5A3,
  CAN_ID_ROBOT_HAND_IMU_GYRO = 0x5A4,
  CAN_ID_ROBOT_HAND_IMU_ACCEL = 0x5A5,
