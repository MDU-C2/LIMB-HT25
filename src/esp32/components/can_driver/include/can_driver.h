...
typedef enum {
  ...
  CAN_RECIPIENT_HUMAN_LOWER_ARM = 0x0C0,     // 0b000'1100'0000
} CanRecipientNode;
...
typedef enum {
  ...
  // IMU messages.
  CAN_ID_ROBOT_SHOULDER_IMU_GYRO_PITCH = 0x5A0, // 0b101'1010'0000
  CAN_ID_ROBOT_SHOULDER_IMU_GYRO_ROLL = 0x5A1,  // 0b101'1010'0001
  CAN_ID_ROBOT_SHOULDER_IMU_GYRO_YAW = 0x5A2,   // 0b101'1010'0010
  CAN_ID_ROBOT_SHOULDER_IMU_ACCEL_X = 0x5A3,    // 0b101'1010'0011
  CAN_ID_ROBOT_SHOULDER_IMU_ACCEL_Y = 0x5A4,    // 0b101'1010'0100
  CAN_ID_ROBOT_SHOULDER_IMU_ACCEL_Z = 0x5A5,    // 0b101'1010'0101
  CAN_ID_ROBOT_ELBOW_IMU_GYRO_PITCH = 0x5A6,    // 0b101'1010'0110
  CAN_ID_ROBOT_ELBOW_IMU_GYRO_ROLL = 0x5A7,     // 0b101'1010'0111
  CAN_ID_ROBOT_ELBOW_IMU_GYRO_YAW = 0x5A8,      // 0b101'1010'1000
  CAN_ID_ROBOT_ELBOW_IMU_ACCEL_X = 0x5A9,       // 0b101'1010'1001
  CAN_ID_ROBOT_ELBOW_IMU_ACCEL_Y = 0x5AA,       // 0b101'1010'1010
  CAN_ID_ROBOT_ELBOW_IMU_ACCEL_Z = 0x5AB,       // 0b101'1010'1011
  ...
  // Human EMG message.
  CAN_ID_HUMAN_UPPER_ARM_EMG = 0x3C0, // 0b011'1100'0000

  // Human IMU messages.
  CAN_ID_HUMAN_UPPER_ARM_IMU_GYRO = 0x5C0,  // 0b101'1100'0000
  CAN_ID_HUMAN_UPPER_ARM_IMU_ACCEL = 0x5C1, // 0b101'1100'0001
} CanMessageId;
