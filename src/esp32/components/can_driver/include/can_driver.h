...
typedef enum {
  ...
  CAN_RECIPIENT_HUMAN_LOWER_ARM = 0x0C0,
} CanRecipientNode;
...
typedef enum {
  ...
  CAN_ID_ROBOT_INDEX_STOP = 0x163,
  CAN_ID_ROBOT_MIDDLE_STOP = 0x164,
  CAN_ID_ROBOT_RING_STOP = 0x165,
  CAN_ID_ROBOT_PINKY_STOP = 0x166,
  ...
  CAN_ID_ROBOT_HAND_SET_GRIP_STATE = 0x266,
  ...
  CAN_ID_ROBOT_SHOULDER_LEFT_RIGHT_POTENTIOMETER = 0x4A3,

  // IMU messages.
  CAN_ID_ROBOT_SHOULDER_IMU_GYRO_PITCH = 0x5A0,
  CAN_ID_ROBOT_SHOULDER_IMU_GYRO_ROLL = 0x5A1,
  CAN_ID_ROBOT_SHOULDER_IMU_GYRO_YAW = 0x5A2,
  CAN_ID_ROBOT_SHOULDER_IMU_ACCEL_X = 0x5A3,
  CAN_ID_ROBOT_SHOULDER_IMU_ACCEL_Y = 0x5A4,
  CAN_ID_ROBOT_SHOULDER_IMU_ACCEL_Z = 0x5A5,
  CAN_ID_ROBOT_ELBOW_IMU_GYRO_PITCH = 0x5A6,
  CAN_ID_ROBOT_ELBOW_IMU_GYRO_ROLL = 0x5A7,
  CAN_ID_ROBOT_ELBOW_IMU_GYRO_YAW = 0x5A8,
  CAN_ID_ROBOT_ELBOW_IMU_ACCEL_X = 0x5A9,
  CAN_ID_ROBOT_ELBOW_IMU_ACCEL_Y = 0x5AA,
  CAN_ID_ROBOT_ELBOW_IMU_ACCEL_Z = 0x5AB,
  CAN_ID_ROBOT_HAND_IMU_GYRO_PITCH = 0x5AC,
  CAN_ID_ROBOT_HAND_IMU_GYRO_ROLL = 0x5AD,
  CAN_ID_ROBOT_HAND_IMU_GYRO_YAW = 0x5AE,
  CAN_ID_ROBOT_HAND_IMU_ACCEL_X = 0x5AF,
  CAN_ID_ROBOT_HAND_IMU_ACCEL_Y = 0x5B0,
  CAN_ID_ROBOT_HAND_IMU_ACCEL_Z = 0x5B1,

  // Pressure sensor messages.
  CAN_ID_ROBOT_THUMB_PRESSURE = 0x7A0,
  CAN_ID_ROBOT_INDEX_PRESSURE = 0x7A1,
  CAN_ID_ROBOT_MIDDLE_PRESSURE = 0x7A2,
  CAN_ID_ROBOT_RING_PRESSURE = 0x7A3,
  CAN_ID_ROBOT_PINKY_PRESSURE = 0x7A4,
