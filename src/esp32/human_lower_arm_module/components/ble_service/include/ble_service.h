 ...
 * When data is ready, it fetches the micro-packets and triggers BLE
 * notifications.
 * * @param event_group The RTOS event group where ADC and IMU services report
 * ready status.
 * @param bits_to_wait Bitmask of the streams to monitor (e.g., EMG_STREAM_BIT |
 * IMU_STREAM_BIT).
