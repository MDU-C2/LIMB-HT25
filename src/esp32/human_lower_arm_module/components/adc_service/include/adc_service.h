...
// __attribute__((packed)) ensures no compiler padding, matching the Python
// receiver's struct format.
...
/**
 * @brief Initializes ADC hardware, internal buffers, and the continuous
 * sampling task.
...
/**
 * @brief Copies the latest processed EMG micro-packet to the destination
 * buffer.
...
/**
 * @brief Copies the latest processed Piezo micro-packet to the destination
 * buffer.
 * @param dest Pointer to the destination memory.
 * @return Size of the copied data in bytes.
 */
