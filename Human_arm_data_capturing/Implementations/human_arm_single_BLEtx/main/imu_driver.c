...
#include <math.h>           // Required for M_PI (for rad/s conversion)
#include "esp_log.h"
...
#define LSM6DSO32_SENSOR_ADDR       0x6A     // I2C device address
...
esp_err_t imu_init(void)
{
    ...
    // Step 2: Check if the sensor is connected by reading WHO_AM_I
    uint8_t who_am_i;
    ...
    // This ensures data registers are not updated until all have been read
