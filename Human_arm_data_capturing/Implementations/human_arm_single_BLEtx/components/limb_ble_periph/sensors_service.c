...
extern uint16_t gEmgValHandle;
extern uint16_t gImuValHandle;
extern uint16_t gPiezoValHandle;

extern void sensor_service_notify(uint16_t val_handle);


void sensor_service_notify_emg(void) {
    sensor_service_notify(gEmgValHandle);
}

void sensor_service_notify_imu(void) {
    sensor_service_notify(gImuValHandle);
}

void sensor_service_notify_piezo(void) {
    sensor_service_notify(gPiezoValHandle);
}
